...
public class Upgrade : MonoBehaviour
{
    ...
    [Header("Informatin Texts")] public Text CoinsTXT;
    ...
    [Header("Upgrades price")] public int[] enginePrice;
    ...
    [Header("Sound Clips")] public AudioClip Buy, Caution;
    public AudioSource audioSource;

    [Header("Show Window")] public GameObject Shop;
    ...
    public void LoadUpgrade()
    {
        ...
        TorqueTXT.text = "Level: " + PlayerPrefs.GetInt("Engine" + id.ToString()).ToString() + " / " +
                         enginePrice.Length.ToString();
        SuspensionTXT.text = "Level: " + PlayerPrefs.GetInt("Suspension" + id.ToString()).ToString() + " / " +
                             suspensionPrice.Length.ToString();
        FuelTXT.text = "Level: " + PlayerPrefs.GetInt("Fuel" + id.ToString()).ToString() + " / " +
                       fuelPrice.Length.ToString();
        SpeedTXT.text = "Level: " + PlayerPrefs.GetInt("Speed" + id.ToString()).ToString() + " / " +
        ...
        if (PlayerPrefs.GetInt("Engine" + id.ToString()) < enginePrice.Length)
        {
            if (PlayerPrefs.GetInt("Coins") >= enginePrice[PlayerPrefs.GetInt("Engine" + id.ToString())])
            {
                ...
                PlayerPrefs.SetInt("Coins",
                    PlayerPrefs.GetInt("Coins") - enginePrice[PlayerPrefs.GetInt("Engine" + id.ToString())]);
    ...
    public void SuspensionUpgrade()
    {
        if (PlayerPrefs.GetInt("Suspension" + id.ToString()) < suspensionPrice.Length)
        {
            if (PlayerPrefs.GetInt("Coins") >= suspensionPrice[PlayerPrefs.GetInt("Suspension" + id.ToString())])
            {
                ...
                audioSource.Play();
                PlayerPrefs.SetInt("Coins",
                    PlayerPrefs.GetInt("Coins") - suspensionPrice[PlayerPrefs.GetInt("Suspension" + id.ToString())]);
    ...
    public void SpeedUpgrade()
    {
        if (PlayerPrefs.GetInt("Speed" + id.ToString()) < speedPrice.Length)
        {
            if (PlayerPrefs.GetInt("Coins") >= speedPrice[PlayerPrefs.GetInt("Speed" + id.ToString())])
            {
                ...
                audioSource.Play();
                PlayerPrefs.SetInt("Coins",
                    PlayerPrefs.GetInt("Coins") - speedPrice[PlayerPrefs.GetInt("Speed" + id.ToString())]);
