...
public class GameManager : Singleton<GameManager>
{
    ...
    public void AddCoin(int value)
    {
        ...
        CoinTXT.transform.localScale = new Vector3(CoinTXT.transform.localScale.x,
    ...
    void CoinDistance()
    {
        if (!c500)
        {
            if (player.transform.position.x >= 500 && player.transform.position.x < 1000)
            {
                ...
                c500 = true;
                PlayerPrefs.SetInt("c500" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:500";
            }
        }
        ...
        if (!c1000 && c500)
        {
            if (player.transform.position.x >= 1000 && player.transform.position.x < 1500)
            {
                ...
                StartCoroutine(Awardfalse());
                c1000 = true;
                PlayerPrefs.SetInt("c1000" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:1000";
            }
        }
        ...
        if (!c1500 && c1000)
        {
            if (player.transform.position.x >= 1500 && player.transform.position.x < 2000)
            {
                ...
                StartCoroutine(Awardfalse());
                c1500 = true;
                PlayerPrefs.SetInt("c1500" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:1500";
            }
        }
        ...
        if (!c2000 && c1500)
        {
            if (player.transform.position.x >= 2000 && player.transform.position.x < 2500)
            {
                ...
                StartCoroutine(Awardfalse());
                c2000 = true;
                PlayerPrefs.SetInt("c2000" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:2000";
            }
        }
        ...
        if (!c2500 && c2000)
        {
            if (player.transform.position.x >= 2500 && player.transform.position.x < 3000)
            {
                ...
                StartCoroutine(Awardfalse());
                c2500 = true;
                PlayerPrefs.SetInt("c2500" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:2500";
            }
        }
        ...
        if (!c3000 && c2500)
        {
            if (player.transform.position.x >= 3000 && player.transform.position.x < 3500)
            {
                ...
                StartCoroutine(Awardfalse());
                c3000 = true;
                PlayerPrefs.SetInt("c3000" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:3000";
            }
        }
        ...
        if (!c3500 && c3000)
        {
            if (player.transform.position.x >= 3500 && player.transform.position.x < 4000)
            {
                ...
                StartCoroutine(Awardfalse());
                c3500 = true;
                PlayerPrefs.SetInt("c3500" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:3500";
            }
        }
        ...
        if (!c4000 && c3500)
        {
            if (player.transform.position.x >= 3700 && player.transform.position.x < 4500)
            {
                ...
                StartCoroutine(Awardfalse());
                c4000 = true;
                PlayerPrefs.SetInt("c4000" + PlayerPrefs.GetInt("SelectedLevel").ToString(),
                    3); // 3 => true | 0 => false
                LastRecord.text = "Record:4000";
